...
export default function mentors() {
  ...
  return (
    <section className=" m:px-16 px-0 pb-16 pt-16 bg-gray-50 ">
      ...
      <div class="scrollbar-hide mt-14 flex w-full snap-x snap-mandatory scroll-px-10 gap-10 overflow-x-scroll scroll-smooth px-10  ">
        ...
        <div class="md:2/3 relative aspect-[3/3] w-[90%] shrink-0 snap-start snap-always rounded-xl sm:w-[44%] md:w-[30%]">
          <div className="flex flex-col rounded-2xl overflow-hidden shadow-xl shadow-[#d8fee243]  h-full">
            <div className="flex flex-col justify-center flex-1 p-6 bg-white lg:py-8 lg:px-7">
              <div className="flex-1">
                <blockquote className="flex-1 mt-8">
                  <p className="text-2sm leading-relaxed text-gray-900 font-pj">
                  &quot; When money is removed from ed-tech, competitive exams become a lot easier, because they are way more easier 
                  than what the aspirants think. When you have mentors who have gone through what you are going through right
                  now the journey will be enjoyable and fun. I feel that OpenGrad will revolutionize the edtech space and provide
                  a level ground for all the aspirants.&quot;
                  </p>
                </blockquote>
              </div>
