   ...
   <section class="py-10 bg-gray-100 sm:py-16 lg:py-24">
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="grid items-center grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 xl:grid-cols-6 sm:gap-x-12 gap-y-12">
            <div class="lg:col-span-2 sm:p-1 p-4">
                <h2 class="text-3xl font-bold font-display leading-tight text-gray-800 sm:text-4xl lg:text-5xl lg:leading-tight">
                   Our Collaborations
                </h2>
            ...
            <div class="lg:col-span-3 xl:col-span-4">
                <div class="grid items-center max-w-4xl grid-cols-2 mx-auto lg:grid-cols-4 gap-x-10 gap-y-16">
                    <div>
                        <img class="object-contain w-full h-20 mx-auto" src="https://upload.wikimedia.org/wikipedia/en/thumb/4/48/IIM_Kozhikode_Logo.svg/1200px-IIM_Kozhikode_Logo.svg.png" alt="" />
                    </div>
                ...
                <div class="flex items-center justify-center mt-10 space-x-3 lg:hidden">
