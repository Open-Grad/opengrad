  ...
  return (
    ...
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-3xl font-bold leading-tight font-display text-gray-800 sm:text-4xl lg:text-5xl">Mentor Speaks  <span className="text-blue-600"></span> </h2>
        </div>
    ...
    <Carousel variant="dark">
      <Carousel.Item className="p-5">
        <div className="overflow-hidden bg-green-100 rounded-md shadow">
          <div className="px-8 py-12">
            ...
            <p className="mt-1 text-base text-gray-600">IIM Calicut</p>
          </div>
        </div>
      </Carousel.Item>
      <Carousel.Item className="p-5">
